...
SELECT EMP_ID, EMP_NAME, DEPT_ID, PHONE, EMAIL, SALARY, SALARY*10
FROM EMPLOYEE;
...
SELECT EMP_ID, EMP_NAME, RETIRE_DATE, SALARY, SALARY*20 AS BONUS
FROM EMPLOYEE
WHERE RETIRE_DATE IS NULL;
...
SELECT EMP_ID, EMP_NAME, IFNULL(SALARY, 0)
FROM EMPLOYEE
WHERE DEPT_ID = 'STG';
...
SELECT EMP_ID, EMP_NAME, IFNULL(RETIRE_DATE, CURDATE())
FROM EMPLOYEE
WHERE DEPT_ID = 'MKT';
